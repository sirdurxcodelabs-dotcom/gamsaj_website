        ...
        <div className="space-top text-center overflow-hidden shape-mockup-wrap">
            ...
            <div className="container">
                <div className="title-area text-center">
                    ...
                    <h2 className="sec-title">Excellence in Every Project We Deliver</h2>
                </div>
                        ...
                        <div className="wcu-card-wrap left-align">
                            <div className="wcu-card">
                                ...
                                <div className="wcu-card-details">
                                    <h4 className="wcu-card-title">Advanced Technology</h4>
                                    <p className="wcu-card-text">Modern construction methods and equipment for efficient project delivery</p>
                                </div>
                            </div>
                            <div className="wcu-card">
                                <div className="wcu-card-icon">
                                ...
                                <div className="wcu-card-details">
                                    ...
                                    <p className="wcu-card-text">Comprehensive project planning ensuring timely completion and cost efficiency</p>
                                </div>
                            </div>
                            <div className="wcu-card">
                                <div className="wcu-card-icon">
                                ...
                                <div className="wcu-card-details">
                                    ...
                                    <p className="wcu-card-text">Proven track record of delivering high-quality projects across Nigeria</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="wcu-card-wrap right-align">
                            <div className="wcu-card">
                                ...
                                <div className="wcu-card-details">
                                    ...
                                    <p className="wcu-card-text">Serving public and private sector clients with professionalism and integrity</p>
                                </div>
                            </div>
                            <div className="wcu-card">
                                <div className="wcu-card-icon">
                                ...
                                <div className="wcu-card-details">
                                    ...
                                    <p className="wcu-card-text">Over 1,100 skilled professionals including engineers, architects, and technicians</p>
                                </div>
                            </div>
                            <div className="wcu-card">
                                <div className="wcu-card-icon">
                                ...
                                <div className="wcu-card-details">
                                    <h4 className="wcu-card-title">Cost Efficiency</h4>
                                    <p className="wcu-card-text">Competitive pricing with strict cost control and value engineering practices</p>
                                </div>
                            </div>
                        </div>
                    </div>
